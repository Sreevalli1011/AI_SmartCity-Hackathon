...
print("\nTraining 60-minute forecasting model...")
...
model_file = MODEL_DIR / "forecast_60m_model.joblib"
...
print("\n===================================")
print("60-MINUTE FORECAST MODEL COMPLETE")
print("===================================")
