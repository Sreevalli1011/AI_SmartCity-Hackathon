...
df = df.dropna(
    subset=["target_congestion_15m"]
)

print(
    f"Rows after removing missing targets: {len(df)}"
)
...
print("\nTraining 15-minute forecasting model...")
...
print("\n===================================")
print("15-MINUTE FORECAST MODEL COMPLETE")
print("===================================")
